...
`endif
  ...
  generate for (genvar i = 0; i < NUM_INTF; i++) begin
    ...
    //assign axis_adap_rx_250mhz_tuser[16+:16]                = s_axis_adap_rx_250mhz_tuser_dst[`getvec(16, i)];
    //assign axis_adap_rx_250mhz_tuser[32+:16]                = s_axis_adap_rx_250mhz_tuser_src[`getvec(16, i)];

    assign axis_adap_rx_250mhz_tuser[16+:16]                = 16'h0;
    assign axis_adap_rx_250mhz_tuser[32+:16]                = 16'h1 << (6 + i);
...
//    assign m_axis_adap_tx_250mhz_tuser_dst[`getvec(16, i)]  = 16'h1 << (6 + i);
    assign m_axis_adap_tx_250mhz_tuser_dst[`getvec(16, i)]  = axis_adap_tx_250mhz_tuser[32+:16];
