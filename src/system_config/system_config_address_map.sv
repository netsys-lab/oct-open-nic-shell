...
// --------------------------------------------------
//   0x100000  |  0x4FFFFF |  Box0 @ 250MHz  -3 ips with 20 bit address (so from 0x100000  to 0x3FFFF + dummy) will be used
// --------------------------------------------------
//   0x500000  |  0x5FFFFF |  Box1 @ 322MHz
// --------------------------------------------------
...
module system_config_address_map #(
  ...
  localparam C_BOX0_BASE_ADDR  = 32'h100000; // 20 bits (3 vitis p4 ips with 20 bit address : 0x100000 + base address: from 0x100000  to 0x3FFFF) will be used)
